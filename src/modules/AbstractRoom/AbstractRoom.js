...
define('AbstractRoom', ['AbstractModule', 'DeviceStorage', 'Utils'], function(AbstractModule, DeviceStorage, Utils){
   ...
   function AbstractRoom(config) {
        ...
        */
        ...
        this.suitableLightConfig = {
          dayInterval: {hStart:6, mStart:0, hEnd:23, mEnd:59} // интервал времени, в который гарантированно будет включаться 220 свет. 
    ...
    */
    AbstractRoom.prototype.getLightState = function(){
        var result = {
            '220': this.getDeviceData(this.devices.switch220),
            '12': this.getDeviceData(this.devices.light12),
            summary: {
                level: null,
    ...
    */
    AbstractRoom.prototype.getMotionState = function(){
        return this.getDeviceData(this.devices.motionSensor);
    };
    ...
    */
    AbstractRoom.prototype.getExtRoomsMotionState = function(){
        return this.extRooms.reduce(function(result, room){
    ...
    */
     ...
     * }
     */
    AbstractRoom.prototype.getDeviceData = function(key){
    ...
    AbstractRoom.prototype.onMotionSensorOn = function(){
        ...
        // TODO дописать this.switchLight
